...
#写入付款记录表
$db->add('sd_onlinepay',['orderid'=>$orderid,'pay_no'=>$norderid,'paymoney'=>$money,'paytype'=>$type,'payway'=>'微信免签(公众号支付)','createdate'=>time()]);
...
$pay=new weixin();
$back=$pay->backurl($db,$norderid);
$back=str_replace('/api/pay/weixin/w','',$back);
