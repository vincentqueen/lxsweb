    ...
    <div class="borders">
        ...
        <div class="ui-tabs ui-tabs-white" data-href="1">
            <ul class="ui-tabs-nav">
              <li class="active"><a href="{THIS_LOCAL}">编辑分类</a></li>
            </ul>
                ...
                <div class="ui-tabs-pane active">
                    ...
                    <form class="ui-form" method="post">
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                <input type="text" name="t0" class="ui-form-ip" value="{$catename}" placeholder="请输入分类名称" data-rule="分类名称:required;">
                            </div>
                        </div>
						<div class="ui-form-group ui-row">
                            <label class="col-left ui-col-form-label">分类图标：</label>
                            <div class="col-right">
                                <input type="text" name="t9" class="ui-form-ip" value="{$cate_icon}" placeholder="请输入分类图标">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                <input type="text" name="t1" class="ui-form-ip" value="{$seotitle}">
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
                            <label class="col-left ui-col-form-label">关键字：</label>
                            <div class="col-right">
                                <input type="text" name="t2" class="ui-form-ip" value="{$seokey}">
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
                            <label class="col-left ui-col-form-label">描述：</label>
                            <div class="col-right">
                                <textarea name="t3" class="ui-form-ip" rows="3" cols="50">{$seodesc}</textarea>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                ...
                                <label class="ui-checkbox"><input type="checkbox" name="t6[]" value="{$rs[gid]}" {if in_array($rs[gid],$view_data)} checked{/if}><i></i>{$rs[gname]}</label>
                                {/sdcms:rs}
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                ...
                                {/if}
                                {sdcms:rs top="0" table="sd_user_group" order="ordnum,gid"}
                                <label class="ui-checkbox"><input type="checkbox" name="t7[]" value="{$rs[gid]}" {if in_array($rs[gid],$post_data)} checked{/if}><i></i>{$rs[gname]}</label>
                                {/sdcms:rs}
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                ...
                                {/if}
                                {sdcms:rs top="0" table="sd_user_group" order="ordnum,gid"}
                                <label class="ui-checkbox"><input type="checkbox" name="t8[]" value="{$rs[gid]}"  {if in_array($rs[gid],$reply_data)} checked{/if}><i></i>{$rs[gname]}</label>
                                {/sdcms:rs}
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t5" id="t5_1" value="1"{if $isshow==1} checked{/if}><i></i>启用</label>
                                <label class="ui-radio"><input type="radio" name="t5" id="t5_2" value="0"{if $isshow==0} checked{/if}><i></i>锁定</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
