                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t1" value="1"{if $islock==1} checked{/if}><i></i>启用</label>
                                <label class="ui-radio"><input type="radio" name="t1" value="0"{if $islock==0} checked{/if}><i></i>锁定</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
