...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{U('index')}">栏目扩展</a> > <a href="{THIS_LOCAL}">编辑字段</a></div>
    <div class="borders">
        <!---->
                ...
                <div class="ui-tabs-pane active">
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t12" value="1" {if $islock==1} checked{/if}><i></i>正常</label>
                                <label class="ui-radio"><input type="radio" name="t12" value="0" {if $islock==0} checked{/if}><i></i>锁定</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
...
$(function(){
    ...
    {elseif $field_type==10||$field_type==11}
