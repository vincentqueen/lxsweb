...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{THIS_LOCAL}">内容扩展</a></div>
    <div class="border">
        <!---->
        <a href="javascript:;" data-url="{U('add')}" class="add-iframe ui-btn ui-btn-info">添加方案</a>
        ...
        <table class="ui-table ui-table-border ui-table-hover ui-table-striped ui-mt ui-mb">
            ...
            <tbody>
            {sdcms:rs top="0" table="sd_extend" where="1=1" order="ordnum,id"}
            {rs:eof}<tr>
            ...
            <tr>
                ...
                <td><a href="{U('extendfield/index',"eid=".$rs[id]."")}"><span class="ui-icon-file-text"></span> 字段管理</a>　<a href="javascript:;" data-url="{U('edit',"id=".$rs[id]."")}" class="edit-iframe"><span class="ui-icon-edit"></span> 编辑</a>　<a href="javascript:;" class="del" data-url="{U('del','id='.$rs[id].'')}"><span class="ui-icon-delete"></span> 删除</a></td>
            </tr>
            {/sdcms:rs}
            </tbody>
        </table>
