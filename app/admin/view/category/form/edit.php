            ...
            <div class="ui-tabs-content">
                <div class="ui-tabs-pane active">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t0" class="ui-form-ip" value="{$title}" placeholder="请输入表单名称" data-rule="表单名称:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">表单标识：</label>
                        <div class="col-right">
                            <input type="text" name="t1" class="ui-form-ip" value="{$tablename}" disabled maxlength="20" placeholder="字母和数字的组合，长度3-50个字符" data-rule="表单标识:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">验证码：</label>
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t2" value="1" {if $iscode==1} checked{/if}><i></i>启用</label>
                            <label class="ui-radio"><input type="radio" name="t2" value="0" {if $iscode==0} checked{/if}><i></i>锁定</label>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">提交后返回：</label>
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t11" value="1" {if $backway==1} checked{/if}><i></i>列表页</label>
                            <label class="ui-radio"><input type="radio" name="t11" value="2" {if $backway==2} checked{/if}><i></i>当前页</label>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t13" value="1" {if $isuser==1} checked{/if}><i></i>开启</label>
                            <label class="ui-radio"><input type="radio" name="t13" value="0" {if $isuser==0} checked{/if}><i></i>关闭</label>
					...
					<div class="ui-form-group ui-row">
                        ...
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t14" value="0" {if $publish_state==0} checked{/if}><i></i>需要审核</label>
                            <label class="ui-radio"><input type="radio" name="t14" value="1" {if $publish_state==1} checked{/if}><i></i>直接通过</label>
					...
					<div class="ui-form-group ui-row"> 
                        ...
                        <div class="col-right">
                            <input type="text" name="t15" class="ui-form-ip" value="{$publish_limit}">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right col-right-top">
                            <label class="ui-radio"><input type="radio" name="t4" value="1" {if $islock==1} checked{/if}><i></i>启用</label>
                            <label class="ui-radio"><input type="radio" name="t4" value="0" {if $islock==0} checked{/if}><i></i>锁定</label>
                        </div>
                    </div>
                    <!--1111-->
                </div>
                ...
                <div class="ui-tabs-pane">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                        	<div class="ui-input-group">
                            	<input type="text" name="t5" id="t5" value="{$add_skins}" class="ui-form-ip radius-right-none">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                        	<div class="ui-input-group">
                            	<input type="text" name="t6" id="t6" value="{$list_skins}" class="ui-form-ip radius-right-none">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                        	<div class="ui-input-group">
                            	<input type="text" name="t7" id="t7" value="{$show_skins}" class="ui-form-ip radius-right-none">
                ...
                <div class="ui-tabs-pane">
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t8" class="ui-form-ip" value="{$seotitle}">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">关键字：</label>
                        <div class="col-right">
                            <input type="text" name="t9" class="ui-form-ip" value="{$seokey}">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">描述：</label>
                        <div class="col-right">
                            <textarea name="t10" rows="4" class="ui-form-ip ui-form-limit" data-max="255">{$seodesc}</textarea>
                            <div class="ui-form-limit-text"><span>{mb_strlen($seodesc)}</span>/255</div>
                        </div>
                    </div>
                    <!--3333-->
                </div>
