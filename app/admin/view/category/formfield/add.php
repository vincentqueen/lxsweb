...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{U('form/index')}">表单管理</a> > <a href="{U('index',"fid=".$fid."")}">{$ftitle}</a> > <a href="{U('index',"fid=".$fid."")}">字段管理</a> > <a href="{THIS_LOCAL}">添加字段</a></div>
    <div class="borders">
        <!---->
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                <div class="ui-input-group">
                                    ...
                                    <select id="t15" class="ui-form-ip after">
                        ...
                        <div class="ui-form-group ui-row dis" id="field_select">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t15" id="t15_1" value="1" ><i></i>是</label>
                                <label class="ui-radio"><input type="radio" name="t15" id="t15_0" value="0" checked><i></i>否</label>
                            </div>
                        </div>
                        ...
                        <div class="ui-form-group ui-row field_data dis">
                            ...
                            <div class="col-right">
                                <input type="text" name="t16" class="ui-form-ip" data-rule="数据表:required;"><span class="input-tips">示范：sd_model_news</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Join参数：</label>
                            <div class="col-right">
                                <input type="text" name="t17" class="ui-form-ip"><span class="input-tips">可以为空，示范：left join sd_content on sd_model_news.cid=sd_content.id</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Where参数：</label>
                            <div class="col-right">
                                <input type="text" name="t18" class="ui-form-ip"><span class="input-tips">可以为空，示范：islock=1</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Order参数：</label>
                            <div class="col-right">
                                <input type="text" name="t19" class="ui-form-ip"><span class="input-tips">可以为空，示范：id desc</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">项目值：</label>
                            <div class="col-right">
                                <input type="text" name="t20" class="ui-form-ip" data-rule="项目值:required;"><span class="input-tips">示范：id</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">项目标签：</label>
                            <div class="col-right">
                                <input type="text" name="t21" class="ui-form-ip" data-rule="项目标签:required;"><span class="input-tips">示范：title</span>
                            </div>
                        </div>
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t14" id="t14_1" value="1"><i></i>是</label>
                                <label class="ui-radio"><input type="radio" name="t14" id="t14_2" value="0" checked><i></i>否</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
    ...
    $("#t2").change(function(){
        switch ($(this).val())
        {
            ...
            case "12":
                ...
                break;
			case "14":
                $("#upload_type,#listval,#field_radio,#editor_type,#field_select").addClass("dis");
