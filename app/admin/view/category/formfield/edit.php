...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{U('form/index')}">表单管理</a> > <a href="{U('index',"fid=".$fid."")}">{$ftitle}</a> > <a href="{U('index',"fid=".$form_id."")}">字段管理</a> > <a href="{THIS_LOCAL}">编辑字段</a></div>
    <div class="borders">
        <!---->
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row dis" id="field_select">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t14" id="t14_1" value="1" {if $field_filter==1} checked{/if}><i></i>是</label>
                                <label class="ui-radio"><input type="radio" name="t14" id="t14_0" value="0" {if $field_filter==0} checked{/if}><i></i>否</label>
                            </div>
                        </div>
                        ...
                        <div class="ui-form-group ui-row field_data dis">
                            ...
                            <div class="col-right">
                                <input type="text" name="t15" class="ui-form-ip" value="{$field_table}" data-rule="数据表:required;"><span class="input-tips">示范：sd_model_news</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Join参数：</label>
                            <div class="col-right">
                                <input type="text" name="t16" class="ui-form-ip" value="{$field_join}"><span class="input-tips">可以为空，示范：left join sd_content on sd_model_news.cid=sd_content.id</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Where参数：</label>
                            <div class="col-right">
                                <input type="text" name="t17" class="ui-form-ip" value="{$field_where}"><span class="input-tips">可以为空，示范：islock=1</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">Order参数：</label>
                            <div class="col-right">
                                <input type="text" name="t18" class="ui-form-ip" value="{$field_order}"><span class="input-tips">可以为空，示范：id desc</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">项目值：</label>
                            <div class="col-right">
                                <input type="text" name="t19" class="ui-form-ip" value="{$field_value}" data-rule="项目值:required;"><span class="input-tips">示范：id</span>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row field_data dis">
                            <label class="col-left ui-col-form-label">项目标签：</label>
                            <div class="col-right">
                                <input type="text" name="t20" class="ui-form-ip" value="{$field_label}" data-rule="项目标签:required;"><span class="input-tips">示范：title</span>
                            </div>
                        </div>
                        ...
                        <div class="ui-form-group ui-row">
                            <label class="col-left ui-col-form-label">列表显示：</label>
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t13" value="1" {if $islist==1} checked{/if}><i></i>是</label>
                                <label class="ui-radio"><input type="radio" name="t13" value="0" {if $islist==0} checked{/if}><i></i>否</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t12" id="t12_1" value="1" {if $islock==1} checked{/if}><i></i>正常</label>
                                <label class="ui-radio"><input type="radio" name="t12" id="t12_2" value="0" {if $islock==0} checked{/if}><i></i>锁定</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
		...
		result:function(form)
		{
			$.ajax(
			{
                ...
                success:function(d)
                {
                    ...
                    {
                        sdcms.success(d.msg);
                       	setTimeout(function(){location.href='{U("index","fid=".$form_id."")}';},1500);
                    }
                    else
                    {
                        sdcms.error(d.msg);
