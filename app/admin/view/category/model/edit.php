...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{U('index')}">模型管理</a> > <a href="{THIS_LOCAL}">编辑模型</a></div>
    <div class="borders">
        <!---->
				...
				<div class="ui-tabs-content">
					<div class="ui-tabs-pane active">
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right">
								<input type="text" name="t0" class="ui-form-ip" value="{$title}" placeholder="请输入模型名称" data-rule="模型名称:required;">
							</div>
						</div>
						<div class="ui-form-group ui-row">
							<label class="col-left ui-col-form-label">模型标识：</label>
							<div class="col-right">
								<input type="text" name="t1" class="ui-form-ip" value="{$tablename}" disabled maxlength="20" data-rule="模型标识:required;">
							</div>
						</div>
						<div class="ui-form-group ui-row">
							<label class="col-left ui-col-form-label">模型描述：</label>
							<div class="col-right">
								<input type="text" name="t2" class="ui-form-ip" value="{$model_desc}">
							</div>
						</div>
						<div class="ui-form-group ui-row">
					...
					<div class="ui-tabs-pane">
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right">
								<div class="ui-input-group">
									<input type="text" name="t3" id="t3" class="ui-form-ip radius-right-none" value="{$list_skins}">
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right">
								<div class="ui-input-group">
									<input type="text" name="t4" id="t4" class="ui-form-ip radius-right-none" value="{$show_skins}">
					...
					<div class="ui-tabs-pane">
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right col-right-top">
								<label class="ui-radio"><input type="radio" name="t8" value="1"{if $leverstate==1} checked{/if}><i></i>开启</label>
								<label class="ui-radio"><input type="radio" name="t8" value="0"{if $leverstate==0} checked{/if}><i></i>关闭</label>
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right col-right-top">
								<label class="ui-radio"><input type="radio" name="t9" value="1"{if $buystate==1} checked{/if}><i></i>开启</label>
								<label class="ui-radio"><input type="radio" name="t9" value="0"{if $buystate==0} checked{/if}><i></i>关闭</label>
						...
						<div class="ui-form-group ui-row">
							...
							<div class="col-right">
								<textarea name="t7" class="ui-form-ip" rows="5" cols="50">{$form_group}</textarea>
