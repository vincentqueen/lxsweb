...
<body>
    <div class="position">当前位置：栏目管理 > <a href="{U('model/index')}">模型管理</a> > <a href="{U('index',"mid=".$mid."")}">{$mtitle}</a> > <a href="{U('index',"mid=".$mid."")}">字段管理</a> > <a href="{THIS_LOCAL}">编辑字段</a></div>
    <div class="borders">
        <!---->
            ...
            <div class="ui-tabs-content">
                <div class="ui-tabs-pane active">
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row{if substr($field_key,0,2)!='my'} dis{/if}">
                            <label class="col-left ui-col-form-label">类型转换：</label>
                            <div class="col-right col-right-top">
                                <label class="ui-radio"><input type="radio" name="t21" id="t21_1" value="1" {if $issys==1} checked{/if}><i></i>系统字段</label>
                                <label class="ui-radio"><input type="radio" name="t21" id="t21_2" value="0" {if $issys==0} checked{/if}><i></i>用户字段</label>
                            </div>
                        </div>
                        <div class="ui-form-group ui-row">
