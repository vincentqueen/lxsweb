...
<body>
    <div class="position">当前位置：城市分站 > <a href="{THIS_LOCAL}">分站设置</a></div>
    <div class="borders">
        <!---->
        <form class="ui-form" method="post">
            <div class="ui-tabs ui-tabs-white" data-href="1">
                <ul class="ui-tabs-nav">
                    {sdcms:rp top="1" table="sd_config_group" where="islock=1 and gkey='city'" order="ordnum,id" auto="j"}
            		{php $gid=$rp[id]}
                    ...
                    <div class="ui-tabs-pane active">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right{if $rs[ctype]==6 && $rs[rtype]==1} col-right-top{/if}">
                                {switch $rs[ctype]}
                                {case 1}<input type="text" name="{$rs[ckey]}" class="ui-form-ip" value="{if APP_DEMO && in_array($rs[ckey],['weixin_appid','weixin_appsecret'])}******{else}{$rs[cvalue]}{/if}">{/case}
