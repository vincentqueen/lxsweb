    ...
    <form class="ui-form" method="post">
        ...
        <div class="ui-form-group ui-row">
            ...
            <div class="ui-col-9 col-right-top">
                <label class="ui-checkbox"><input name="t1[]" type="checkbox" value="1"><i></i>添加内容</label>
                <label class="ui-checkbox"><input name="t1[]" type="checkbox" value="2"><i></i>编辑内容</label>
                <label class="ui-checkbox"><input name="t1[]" type="checkbox" value="3"><i></i>批量设置</label>
                <label class="ui-checkbox"><input name="t1[]" type="checkbox" value="4"><i></i>删除内容</label>
            </div>
        </div>
        <div class="ui-form-group ui-row">
            <label class="ui-col-3 ui-col-form-label">审核设置：</label>
            <div class="ui-col-9 col-right-top">
                <label class="ui-checkbox"><input name="t2" type="checkbox" value="1"><i></i>需要审核</label>
            </div>
        </div>
        <div class="ui-form-group ui-row">
