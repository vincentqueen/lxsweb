...
<body>
    ...
    <div class="border">
        <!---->
        <a href="{U('add')}" class="ui-btn ui-btn-info">添加广告</a>
        ...
        <table class="ui-table ui-table-border ui-table-hover ui-table-striped ui-mb ui-mt">
            ...
            <tbody>
            {sdcms:rs top="0" table="sd_ad" where="1=1" order="ordnum,id"}
            {rs:eof}
            <tr>
            ...
            <tr>
                ...
                <td><a href="{U('edit',"id=".$rs[id]."")}"><span class="ui-icon-edit"></span> 编辑</a>{if $rs[akey]==''}　<a href="javascript:;" class="del" data-url="{U('del','id='.$rs[id].'')}"><span class="ui-icon-delete"></span> 删除</a>{/if}</td>
            </tr>
            {/sdcms:rs}
            </tbody>
        </table>
