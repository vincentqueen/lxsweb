...
<body>
    <div class="position">当前位置：扩展管理 > <a href="{U('index')}">询价管理</a></div>
    <div class="border">
        <!---->
        <div class="navbar">
            <div class="lefter">
                ...
                <span class="ui-btn-group ui-btn-group-yellow ui-btn-group-bg">
                    ...
                    <a class="ui-btn-group-item{if $type==1} active{/if}" href="{U('index','type=1')}">未处理</a>
                    <a class="ui-btn-group-item{if $type==2} active{/if}" href="{U('index','type=2')}">已处理</a>
                </span>
            </div>
