...
<body>
    <div class="position">当前位置：扩展管理 > <a href="{U('index')}">链接管理</a> > <a href="{THIS_LOCAL}">链接配置</a></div>
    <div class="borders">
        <!---->
        <form class="ui-form" method="post">
            <div class="ui-tabs ui-tabs-white" data-href="1">
                <ul class="ui-tabs-nav">
                    {sdcms:rp top="1" table="sd_config_group" where="islock=1 and gkey='link'" order="ordnum,id" auto="j"}
            		{php $gid=$rp[id]}
