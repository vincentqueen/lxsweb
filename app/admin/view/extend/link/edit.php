    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" value="{$webname}" placeholder="请输入网站名称" data-rule="网站名称:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row {if C('link_logo')==0} dis{/if}">
                ...
                <div class="ui-col-9">
                    <div class="ui-input-group">
                        <input type="text" name="t1" id="t1" class="ui-form-ip radius-right-none" value="{$weblogo}">
            ...
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t2" class="ui-form-ip" value="{$weburl}" placeholder="请输入网址" data-rule="网址:required;">
                </div>
            </div>
            ...
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9 col-right-top">
                	<label class="ui-radio"><input type="radio" name="t5" value="1" {if $islock==1} checked{/if}><i></i>启用</label>
                    <label class="ui-radio"><input type="radio" name="t5" value="0" {if $islock==0} checked{/if}><i></i>锁定</label>
                </div>
            </div>
