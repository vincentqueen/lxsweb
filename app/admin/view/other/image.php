...
<div class="ui-tabs ui-tabs-white" data-href="1">
	<ul class="ui-tabs-nav">
	  <li class="active"><a href="{U('imagelist','type='.$type.'&multiple='.$multiple.'&gid=0&iseditor='.$iseditor.'&islocal='.$islocal.'&thumb='.$thumb.'&water='.$water.'')}">附件选择</a></li>
	  <li><a href="{U('imageupload','type='.$type.'&multiple='.$multiple.'&gid='.$gid.'&iseditor='.$iseditor.'&islocal='.$islocal.'&thumb='.$thumb.'&water='.$water.'')}">本地上传</a></li>
	</ul>
