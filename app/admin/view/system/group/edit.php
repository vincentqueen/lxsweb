    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            ...
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <select name="t3" class="ui-form-ip" data-rule="分类:required;">
                    	<option value="">请选分类</option>
                        <option value="1"{if $types==1} selected{/if}>网站设置</option>
                        <option value="2"{if $types==2} selected{/if}>接口设置</option>
                    </select>
                </div>
            </div>
            <div class="ui-form-group ui-row">
