...
<body>
    ...
    <div class="border">
        <!---->
        <a href="javascript:;" data-url="{U('add')}" class="add-iframe ui-btn ui-btn-info ui-mr-sm">添加分组</a>
        ...
        <table class="ui-table ui-table-border ui-table-hover ui-table-striped ui-mb ui-mt">
            ...
            <tbody>
            {sdcms:rs top="0" table="sd_config_group" where="gkey='0'" order="ordnum,id"}
            <tr>
                ...
                <td>{if $rs[types]==1}网站设置{else}接口设置{/if}</td>
