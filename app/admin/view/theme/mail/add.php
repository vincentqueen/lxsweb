...
<body>
    <div class="position">当前位置：模板插件 > <a href="{U('index')}">邮件模板</a> > <a href="{THIS_LOCAL}">添加模板</a></div>
    <div class="borders">
        <!---->
        <div class="ui-tabs ui-tabs-white" data-href="1">
            <ul class="ui-tabs-nav">
              <li class="active"><a href="{THIS_LOCAL}">添加模板</a></li>
            </ul>
            <div class="ui-tabs-content">
                ...
                <!--loop-->
                    ...
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t0" class="ui-form-ip" placeholder="请输入用途" data-rule="用途:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">邮件标题：</label>
                        <div class="col-right">
                            <input type="text" name="t1" class="ui-form-ip" placeholder="请输入邮件标题" data-rule="邮件标题:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">邮件内容：</label>
                        <div class="col-right-full">
                            <script id="t2" name="t2" class="ui-editor" type="text/plain"></script>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
