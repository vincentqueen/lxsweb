...
<body>
    <div class="position">当前位置：模板插件 > <a href="{U('index')}">邮件模板</a> > <a href="{THIS_LOCAL}">编辑模板</a></div>
    <div class="borders">
        <!---->
            ...
            <div class="ui-tabs-content">
                ...
                <form class="ui-form" method="post">
                    <div class="ui-form-group ui-row">
                        ...
                        <div class="col-right">
                            <input type="text" name="t0" class="ui-form-ip" value="{$title}" placeholder="请输入用途" data-rule="用途:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">邮件标题：</label>
                        <div class="col-right">
                            <input type="text" name="t1" class="ui-form-ip" value="{$mail_title}" placeholder="请输入邮件标题" data-rule="邮件标题:required;">
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
                        <label class="col-left ui-col-form-label">邮件内容：</label>
                        <div class="col-right-full">
                        	<script id="t2" name="t2" class="ui-editor" type="text/plain">{$mail_content}</script>
                        </div>
                    </div>
                    <div class="ui-form-group ui-row">
