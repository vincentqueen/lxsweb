    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" placeholder="请输入用户名" data-rule="用户名:required;username;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">密码：</label>
                <div class="ui-col-9">
                    <input type="text" name="t1" class="ui-form-ip" placeholder="请输入密码" data-rule="密码:required;password;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">邮箱：</label>
                <div class="ui-col-9">
                    <input name="t2" type="text" class="ui-form-ip" placeholder="请输入邮箱" data-rule="邮箱:required;email;">
                </div>
            </div> 
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <select name="t3" data-rule="会员组:required;" class="ui-form-ip">
                        ...
                        <option value="{$rs[gid]}">{$rs[gname]}</option>
                        {/sdcms:rs}
                    </select>
                </div>
            </div>
