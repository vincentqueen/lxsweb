    ...
    <div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" value="{$uname}" placeholder="请输入用户名" data-rule="用户名:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                ...
                <div class="ui-col-9">
                    ...
                    <span class="input-tips">不修改请留空</span>
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">邮箱：</label>
                <div class="ui-col-9">
                    <input type="text" name="t2" class="ui-form-ip" value="{$uemail}" data-rule="邮箱:required;email;">
                </div>
            </div> 
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">会员组：</label>
                <div class="ui-col-9">
                    <select name="t3" data-rule="会员组:required;" class="ui-form-ip">
