...
<body>
    <div class="position">当前位置：微信公众号 > <a href="{U('index')}">关键字回复</a> > <a href="{THIS_LOCAL}">添加关键字</a></div>
    <div class="border">
        <!---->
        <div class="form-subject">添加关键字</div>
        <form class="ui-form" method="post">
            ...
            <div class="ui-form-group ui-row dis" id="reply_content">
                ...
                <div class="col-right">
                    <textarea name="t2" rows="5" class="ui-form-ip" data-rule="回复内容:required;"></textarea>
                </div>
            </div>
            ...
            <div class="ui-form-group ui-row">
                ...
                <div class="col-right">
                    <label class="ui-radio"><input type="radio" name="t4" id="t4_1" value="1" checked><i></i>模糊匹配</label>
                    <label class="ui-radio"><input type="radio" name="t4" id="t4_2" value="2"><i></i>完全匹配</label>
                </div>
            </div>
            <div class="ui-form-group ui-row">
