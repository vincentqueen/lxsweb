...
<body>
    <div class="position">当前位置：微信公众号 > <a href="{U('index')}">菜单管理</a> > <a href="{THIS_LOCAL}">编辑菜单</a></div>
    <div class="border">
        <!---->
        <div class="form-subject">编辑菜单</div>
        <form class="ui-form" method="post">
            ...
            <div class="ui-form-group ui-row" id="reply_content">
               <label class="col-left ui-col-form-label">消息内容：</label>
                <div class="col-right">
                    <textarea name="t2" rows="5" class="ui-form-ip" data-rule="消息内容:required;">{$reply_text}</textarea>
                </div>
            </div>
            ...
            <div class="ui-form-group ui-row" id="reply_url">
               <label class="col-left ui-col-form-label">网页链接：</label>
                <div class="col-right">
                    <input type="text" name="t4" class="ui-form-ip" value="{$reply_url}" data-rule="网页链接:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row dis" id="appid">
               <label class="col-left ui-col-form-label">小程序appid：</label>
                <div class="col-right">
                    <input type="text" name="t5" class="ui-form-ip" value="{$appid}" data-rule="小程序appid:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row dis" id="pagepath">
               <label class="col-left ui-col-form-label">小程序页面路径：</label>
                <div class="col-right">
                    <input type="text" name="t6" class="ui-form-ip" value="{$pagepath}" data-rule="小程序的页面路径:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
               <label class="col-left ui-col-form-label">排序：</label>
                <div class="col-right">
                    <input type="text" name="t7" class="ui-form-ip" value="{$ordnum}">
