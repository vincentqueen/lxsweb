...
<body>
    <div class="position">当前位置：栏目管理 > <a href="<?php echo THIS_LOCAL;?>">栏目扩展</div>
    <div class="border">
        <!---->
        <a href="<?php echo U('add');?>" class="ui-btn ui-btn-info ui-mr-sm">添加字段</a>
        ...
        <table class="ui-table ui-table-border ui-table-hover ui-table-striped ui-mt ui-mb">
            ...
            <tbody>
            <?php $array_rs=$this->db->load("select * from sd_category_field  where 1=1  order by ordnum,id ",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?><tr>
...
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
            ...
            <tr>
                ...
                <td>
                    <?php switch ($rs['field_type']){ case 1: ?>普通文本<?php break; ?>                    <?php case 2: ?>普通文本-日期<?php break; ?>                    <?php case 3: ?>普通文本-整数<?php break; ?>                    <?php case 4: ?>普通文本-价格<?php break; ?>                    <?php case 5: ?>普通文本-上传<?php break; ?>                    <?php case 6: ?>普通文本-密码<?php break; ?>                    <?php case 7: ?>普通文本-隐藏域<?php break; ?>                    <?php case 8: ?>多行文本框<?php break; ?>                    <?php case 9: ?>单选按钮<?php break; ?>                    <?php case 10: ?>复选框<?php break; ?>                    <?php case 11: ?>下拉菜单<?php break; ?>                    <?php case 12: ?>编辑器<?php break; ?>                <?php }?></td>
