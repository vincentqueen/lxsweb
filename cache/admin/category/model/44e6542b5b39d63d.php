...
<div class="border_iframe">
        ...
        <form class="ui-form" method="post">
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">模型名称：</label>
                <div class="ui-col-9">
                    <input type="text" name="t0" class="ui-form-ip" placeholder="请输入模型名称" data-rule="模型名称:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">模型标识：</label>
                <div class="ui-col-9">
                    <input type="text" name="t1" class="ui-form-ip" maxlength="20" placeholder="字母和数字的组合，长度3-50个字符" data-rule="模型标识:required;">
                </div>
            </div>
            <div class="ui-form-group ui-row">
                <label class="ui-col-3 ui-col-form-label">数据源：</label>
                <div class="ui-col-9">
                    <select name="t2" class="ui-form-ip" data-rule="数据源:required;">
...
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                        <option value="<?php echo $rs['id'];?>"<?php if ($id==$rs['id']) { ?> selected<?php }?>><?php echo $rs['title'];?></option>
                        <?php } if($total_rs>0){ ?>
<?php }?>
                    </select>
                </div>
