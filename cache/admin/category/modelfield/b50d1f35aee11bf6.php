...
<body>
    <div class="position">当前位置：栏目管理 > <a href="<?php echo U('model/index');?>">模型管理</a> > <a href="<?php echo U('index',"mid=".$mid."");?>"><?php echo $mtitle;?></a> > <a href="<?php echo U('index',"mid=".$mid."");?>">字段管理</a> > <a href="<?php echo THIS_LOCAL;?>">添加字段</a></div>
    <div class="borders">
        <!---->
        
        <div class="ui-tabs ui-tabs-white" data-href="1">
            <ul class="ui-tabs-nav">
              <li class="active"><a href="<?php echo THIS_LOCAL;?>">添加字段</a></li>
            </ul>
                ...
                <div class="ui-tabs-pane active">
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                <div class="ui-input-group">
                                    ...
                                    <select id="after" class="ui-form-ip after">
                        ...
                        <div class="ui-form-group ui-row">
                            ...
                            <div class="col-right">
                                <select name="t14" class="ui-form-ip" data-rule="表单分组:required;">
		...
		result:function(form)
		{
			$.ajax(
			{
                ...
                success:function(d)
                {
                    ...
                    {
                        sdcms.success(d.msg);
                       	setTimeout(function(){location.href='<?php echo U("index","mid=".$mid."");?>';},1500);
                    }
                    else
                    {
                        sdcms.error(d.msg);
