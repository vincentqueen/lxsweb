...
.bar{position:absolute;top:50%;left:0;transform:translateY(-50%);background:url(<?php echo WEB_ROOT;?>public/admin/images/arrow.png) no-repeat left;width:22px;height:106px;}
...
<body>
    ...
    <div class="ui-layout-center"><iframe name="content_body" id="content_body" src="<?php echo U('lists');?>" width="100%" height="100%" frameborder="0" style="display:block;"></iframe></div>
