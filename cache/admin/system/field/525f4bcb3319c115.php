...
<body>
    <div class="position">当前位置：系统管理 > <a href="<?php echo U('configgroup/index');?>">设置分组</a> > <a href="<?php echo U('index',"gid=".$gid."");?>">字段管理</a> > <a href="<?php echo THIS_LOCAL;?>">添加字段</a></div>
    <div class="borders">
        <!---->
                ...
                <div class="ui-tabs-pane active">
                    ...
                    <form class="ui-form" method="post">
                        ...
                        <div class="ui-form-group ui-row dis" id="showway">
                            <label class="col-left">排列方式：</label>
                            <div class="col-right">
		...
		result:function(form)
		{
			$.ajax(
			{
                ...
                success:function(d)
                {
                    ...
                    {
                        sdcms.success(d.msg);
                        setTimeout(function(){location.href='<?php echo U("index","gid=".$gid."");?>';},1500);
                    }
                    else
                    {
                        sdcms.error(d.msg);
