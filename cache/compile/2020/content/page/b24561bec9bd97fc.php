                ...
                <div class="pbody">
                    ...
                    <div class="p-berneck-intro mgs" id="j_intro">
                        <div class="wm">
                            ...
                            <div class="main">
                            <?php $array_rs=$this->db->load("select * from sd_model_pro left join sd_content on sd_model_pro.cid=sd_content.id where id=38   limit 1",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
...
<?php }?>
                    ...
                    <div class="p-berneck-ads" id="j_ads">
                        <ul>
                            <?php $array_rs=$this->db->load("select * from sd_content  where classid=51  order by ontop desc,ordnum desc,id                             desc ",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                            <li>
