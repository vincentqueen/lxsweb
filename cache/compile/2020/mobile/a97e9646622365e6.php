<?php defined('IN_SDCMS') or die(); if(!defined('IN_SDCMS')) exit;?>
        ...
        <div class="ui-modal-body">
            ...
            <form class="ui-form" id="form_inquiry" method="post">
                <div class="ui-form-group ui-row">
            		...
            		<div class="ui-col-9">
                    	<input type="text" name="truename" class="ui-form-ip" value="<?php echo $truename;?>" placeholder="请输入您的姓名" data-rule="姓名:required;">
                    </div>
                </div>
                <div class="ui-form-group ui-row">
                    <label class="ui-col-3 ui-col-form-label ui-text-right">手机：</label>
            		<div class="ui-col-9">
                    	<input type="text" name="mobile" maxlength="11" class="ui-form-ip" value="<?php echo $mobile;?>" placeholder="请输入您的手机号码" data-rule="手机号码:required;mobile;">
                    </div>
                </div>
                <div class="ui-form-group ui-row">
                ...
                <div class="ui-form-group ui-row ui-mb-0">
            		...
            		<div class="ui-col-9">
                    	<input type="hidden" name="token" value="<?php echo $token;?>"><button type="submit" class="ui-btn ui-btn-blue">提交询价</button>
                    </div>
                </div>
            </form>
            <!---->
    ...
    <div class="ui-modal" id="my-order">
        ...
        <div class="ui-modal-body">
        	<!---->
            <?php if (add_city(C(strtoupper('web_order_login')),3)==1 && USER_ID==0) { ?>
            	请先<a href="<?php echo N('login');?>" class="ui-text-red ui-ml ui-mr">登录</a>或<a href="<?php echo N('reg');?>" class="ui-text-red ui-ml ui-mr">注册</a>
            <?php } else { ?>
            <form class="ui-form" id="form_order" method="post">
                ...
                <div class="ui-form-group ui-row">
            		...
            		<div class="ui-col-9">
                    	<input type="text" name="address" maxlength="255" class="ui-form-ip" value="<?php echo $address;?>" placeholder="请输入收货地址" data-rule="收货地址:required;">
                    </div>
                </div>
                <div class="ui-form-group ui-row">
                ...
                <div class="ui-form-group ui-row ui-mb-0">
                    <label class="ui-col-3 ui-col-form-label ui-text-right"></label>
            		<div class="ui-col-9">
                    	<input type="hidden" name="token" value="<?php echo $token;?>"><button type="submit" class="ui-btn ui-btn-blue">提交订单</button>
                    </div>
                </div>
            </form>
            <?php }?>
	...
	<div class="ui-footbar ui-fixed-bottom ui-mwidth">
		<div class="ui-footbar-left">
			<a href="<?php echo $webroot;?>"><i class="ui-icon-home"></i>首页</a>
		</div>
		<div class="ui-footbar-right">
			<a href="javascript:;" class="ui-modal-show" data-target="#my-inquiry">询价</a>
			<?php if ($price>0) { ?><a href="javascript:;" class="ui-modal-show" data-target="#my-order">订购 <sub>￥</sub><?php echo $price;?></a><?php }?>
		</div>
	</div>
		...
		$("#form_inquiry").form(
		{
			...
			result:function(form)
			{
				$.ajax(
				{
					...
					cache:false,
					dataType:'json',
					url:'<?php echo U("other/inquiry/","id=".$id."","",1);?>',
					data:$(form).serialize(),
		...
		$("#form_order").form(
		{
			...
			result:function(form)
			{
				$.ajax(
				{
					...
					cache:false,
					dataType:'json',
					url:'<?php echo U("other/order/","id=".$id."","",1);?>',
					data:$(form).serialize(),
					error:function(e){alert(e.responseText);},
					success:function(d)
					{
