...
<div class="mbnr">
  <div class="in"><img src="<?php echo $mynybanner;?>" alt="欧松板"></div>
</div>

<div class="bodyer">
    <div class="pwrap p-berneck">
        <div class="pbody">
            <div class="p-berneck-profile p-luhua-profile" id="j_brand">
                <div class="wm">
            ...
            <div class="p-berneck-intro p-luhua-intro" id="j_intro">
                <div class="wm">
                    <div class="tit"><span><?php echo $rs[title];?></span></div>
                    <?php $array_rs=$this->db->load("select * from sd_model_pro left join sd_content on sd_model_pro.cid=sd_content.id where id=16   limit 1",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                    <div class="bd">
                        <div class="txt"><?php echo $rs['intro'];?></div>
                        <div class="demo"><img src="<?php echo WEB_THEME;?>mobile/static/picture/berneck-05.jpg"></div>
                        <div class="metas">
...
<?php }?>
            ...
            <div class="p-berneck-ads" id="j_ads">
                <ul>
                <?php $array_rs=$this->db->load("select * from sd_content  where classid=39  order by ontop desc,ordnum desc,id desc ",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                    <li>
                ...
                <div class="wm">
                    ...
                    <div class="bd">
                        <div class="berneck-certs swiper-container" id="j_certs_slide">
                            ...
                            <?php $array_rs=$this->db->load("select * from sd_model_page  where cid=40   limit 1",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
