...
<body class="page-berneck">
    <div class="app-main">
        ...
        <!--header-->
        <div class="mbnr">
            <div class="in"><img src="<?php echo $mynybanner;?>" alt="赛琳芬"></div>
        </div>
                    ...
                    <div class="p-berneck-profile" id="j_brand">
                        <div class="wm">
                            <div class="pcont xcont">
                                ...
                                <div style="margin-top:48px;text-align:center;"><img src="<?php echo WEB_THEME;?>mobile/static/picture/berneck-01.jpg" alt="品牌图标"></div>
                            </div>
                        </div>
                    </div>
...
<?php }?>
                    ...
                    <div class="p-berneck-ads" id="j_ads">
                        <ul>
                        <?php $array_rs=$this->db->load("select * from sd_content  where classid=26   ",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="txt">
                                    <?php echo cutstr(nohtml($rs['intro']),210,1);?>
                                    </div>
                                </div>
                            </li>
                            <?php } if($total_rs>0){ ?>
                        ...
                        <div class="wm">
                            ...
                            <div class="bd">
                                <div class="berneck-certs swiper-container" id="j_certs_slide">
                                    ...
                                    <?php $array_rs=$this->db->load("select * from sd_model_page  where cid=27   limit 1",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
