...
<body class="page-berneck">
    <div class="app-main">
        ...
        <div class="mbnr">
            <div class="in"><img src="<?php echo $mynybanner;?>" alt="Banner"></div>
        </div>
        ...
        <div class="bodyer">
            ...
            <div class="p-intro p-auvico-intro" id="j_intro">
                <div class="wm">
                    ...
                    <?php $array_rs=$this->db->load("select * from sd_model_pro left join sd_content on sd_model_pro.cid=sd_content.id where id=6   limit 1",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                    <div class="bd">
                      <p class="txt"><?php echo $rs['intro'];?></p>
                      <div class="diagram"><img src="<?php echo WEB_THEME;?>mobile/static/picture/auvico-03.jpg"></div>
                      <div class="txt">
...
<?php }?>
                    ...
                    <div class="p-features p-berneck-ads" id="j_ads">
                        <ul>
                        <?php $array_rs=$this->db->load("select * from sd_content  where classid=31  order by ontop desc,ordnum desc,id desc ",0,false,0);$total_rs=count($array_rs);if($total_rs==0){ ?>
<?php } else{ ?>
<?php $i=0;} foreach($array_rs as $rs){ $i++;?>
                            <li>
