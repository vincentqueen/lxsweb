...
<body>
    ...
    <div class="width inner_container">
        <div class="install">
            ...
            <div class="ui-text-center ui-mt-30"><input type="hidden" name="token" value="<?php echo $token;?>"><button class="ui-btn ui-mr" onClick="location.href='./'">上一步</button><button class="ui-btn ui-btn-blue" onClick="location.href='?act=config'" <?php if (!$result) { ?>disabled<?php }?>><?php if (!$result) { ?>请检查不符合的项目<?php } else { ?>下一步<?php }?></button></div>
        </div>
