...
<body>
    ...
    <div class="width inner_container">
        <div class="install">
            ...
            <div class="ui-text-center ui-mt-20"><input type="hidden" name="token" value="{$token}"><button type="button" class="ui-btn ui-mr" onClick="location.href='?act=check'">上一步</button><button type="submit" id="sdcms-submit" class="ui-btn ui-btn-blue">下一步</button></div>
        </div>
