...
<body>
    ...
    <div class="width inner_container">
        <div class="install">
            ...
            <div class="ui-text-center ui-mt-30"><input type="hidden" name="token" value="{$token}"><button type="submit" class="ui-btn ui-btn-blue">同意安装协议并继续</button></div>
        </div>
    </div>
    </form>
