...
{php $self_ename='bbs'}
{php $position=[['name'=>$self_name,'url'=>N('bbs')],['name'=>'编辑主题','url'=>THIS_LOCAL]]}
{include file="include/top.php"}
<title>编辑主题_{sdcms[web_name]}</title>
...
<body>
	...
	<div class="container">
		<div class="width">
			 <div class="ui-box">
				<!--begin-->
				{include file="include/bbs/edit.php"}
				<!--over-->
			</div>
		</div>
	</div>
	...
	{include file="include/bbs/edit_foot.php"}
