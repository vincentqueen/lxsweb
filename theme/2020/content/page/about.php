            ...
            <div class="pwrap p-about">
                <div class="pbody">
                    ...
                    <div class="p-about-scale" id="j_channel">
                        <div class="wm">
                            <div class="p-about-scale-img-wrap">
                                <img src="{WEB_THEME}static/image/ab-wn.jpg" alt="企业文化">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bd">
                                <div class="berneck-certs swiper-container" id="j_certs_slide">
                                    <div class="swiper-wrapper">
                                        {sdcms:rs top="1" table="sd_model_page" where="cid=21" order="pageid desc"}
                        ...
                        <div class="wm">
                            ...
                            <div class="bd">
                                <div class="berneck-certs swiper-container" id="j_certs1_slide">
                                    <div class="swiper-wrapper">
                                        {sdcms:rs top="1" table="sd_model_page" where="cid=53" order="pageid desc"}
                                        {php $piclist=jsdecode($rs[piclist],1);}
                                        {/sdcms:rs}
                                        {foreach $piclist as $key=>$rs}
                                        <div class="swiper-slide certs-item">
