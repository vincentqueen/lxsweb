            ...
            <div class="pwrap p-berneck">
                <div class="pbody">
                    ...
                    <div class="p-berneck-intro" id="j_intro">
                        <div class="wm">
                        {sdcms:rs top="1" table="sd_model_pro" join="left join sd_content on sd_model_pro.cid=sd_content.id" where="id=1"}
                        ...
                        <div class="wm">
                            ...
                            <div class="bd">
                                <div class="berneck-clotys swiper-container" id="j_clotys_slide">
                                    ...
                                    {sdcms:rs top="1" table="sd_model_page" where="cid=46"}
                    ...
                    <div class="p-berneck-cert" id="j_certs">
                        <div class="wm">
                            ...
                            <div class="bd">
                                ...
                                <img src="{WEB_THEME}static/image/sq5.jpg" alt="授权厂家">
                                <img src="{WEB_THEME}static/image/sq6.jpg" alt="授权厂家">
                                <img src="{WEB_THEME}static/image/sq7.jpg" alt="授权厂家">
                            </div>
                        </div>
                    </div>
