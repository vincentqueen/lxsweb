                        ...
                        <div class="wm">
                            ...
                            <div class="bd">
                                ...
                                <div class="tbl" style="margin-top: 20px;">
                                    <img src="{$rs[pictwo]}" alt="参数表格" style="max-width: 100%; border-radius: 8px;">
                                </div>
                            </div>
                            <div class="diagram">
                                <img src="{if !isempty($rs[pic])}{$rs[pic]}{else}{WEB_THEME}static/image/berneck-05-copy.png{/if}" alt="产品展示" style="width: 100%; border-radius: 20px;">
                            </div>
                            {/sdcms:rs}
                        </div>
                    </div>
                        ...
                        <div class="wm">
                            ...
                            <div class="bd">
                                ...
                                <div class="cloty-grid">
                                    {sdcms:rs top="1" table="sd_model_page" where="cid=52" order="pageid desc"}
