            ...
            <div class="pwrap p-berneck">
                <div class="pbody">
                        ...
                        <div class="wm">
                            <div class="pcont xcont">
                                ...
                                <div style="margin-top:48px;text-align:center;">
                                    <img src="{WEB_THEME}mobile/static/picture/berneck-01.jpg" alt="赛琳芬">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-berneck-intro" id="j_intro">
                        <div class="wm">
                            {sdcms:rs top="1" table="sd_model_pro" join="left join sd_content on
                            sd_model_pro.cid=sd_content.id" where="id=1"}
                    ...
                    <div class="p-berneck-ads" id="j_ads">
                        <ul>
                            ...
                            {/sdcms:rs} -->
                            <li>
                               <img src="{WEB_THEME}mobile/static/picture/berneck-ads-01.jpg">
                                   <div class="info">
                                   <h5>1、100％纯正火炬松木</h5>
                                         <div class="txt">BERNECK   采用100%亚马逊PINUS TAEDA火炬松作为原料，火炬松松脂分泌少
                                            ，纤维韧性强，无任何杂质，生产选用平均生长20年的通直径材，萃取原木最优质部分，去掉树皮枝叶，不掺加任何杂质，
                                            废料，色泽金黄统一，基材散发淡雅清香。
                                        </div>
                                    </div>
                            </li>
                            ...
                            <div class="bd">
                                <div class="berneck-certs swiper-container" id="j_certs_slide">
                                    <div class="swiper-wrapper">
                                        {sdcms:rs top="1" table="sd_model_page" where="cid=27"}
