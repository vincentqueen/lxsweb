...
<body class="page-berneck">
    <div class="app-main">
        ...
        <!--header-->
        <div class="mbnr">
            <div class="in"><img src="{$mynybanner}" alt="赛琳芬"></div>
        </div>
            ...
            <div class="pwrap p-berneck">
                <div class="pbody">
                    <div class="p-berneck-profile" id="j_brand">
                        <div class="wm">
                            <div class="pcont xcont">
                                <p>{$content}</p>
                                <div style="margin-top:48px;text-align:center;"><img src="{WEB_THEME}mobile/static/picture/berneck-01.jpg" alt="品牌图标"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-berneck-ads" id="j_ads">
                        <ul>
                        {sdcms:rs top="0" table="sd_content" where="classid=26"}
                            <li>
                                <img src="{$rs[pic]}">
                                <div class="info">
                                    <h5>{$rs[title]}</h5>
                                    <div class="txt">
                                    {cutstr(nohtml($rs[intro]),210,1)}
                                    </div>
                                </div>
                            </li>
                            {/sdcms:rs}
