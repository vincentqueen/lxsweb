...
<div class="mbnr">
  <div class="in"><img src="{$mynybanner}" alt="无醛板"></div>
</div>
<div class="bodyer">
    <div class="pwrap p-berneck">
        <div class="pbody">
            ...
            <div class="p-berneck-intro p-aige-intro" id="j_intro">
                ...
                {sdcms:rs top="1" table="sd_model_pro" join="left join sd_content on sd_model_pro.cid=sd_content.id" where="id=11"}
                    ...
                    <div class="bd">
                        ...
                        <div class="demo"><img src="{WEB_THEME}mobile/static/picture/aige-05-m.jpg"></div>
                        <div class="metas">
            ...
            <div class="p-berneck-ads" id="j_ads">
                <ul>
                {sdcms:rs top="0" table="sd_content" where="classid=35"}
                    <li>
                        <img src="{$rs[pic]}">
                        <div class="info">
                            <h5>{$rs[title]}</h5>
                ...
                <div class="wm">
                    ...
                    <div class="bd">
                        <div class="berneck-certs swiper-container" id="j_certs_slide">
                            ...
                            {sdcms:rs top="1" table="sd_model_page" where="cid=36"}
