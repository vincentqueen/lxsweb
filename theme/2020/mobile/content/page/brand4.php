...
<div class="mbnr">
  <div class="in"><img src="{$mynybanner}" alt="欧松板"></div>
</div>
            ...
            <div class="p-berneck-intro p-luhua-intro" id="j_intro">
                <div class="wm">
                    ...
                    <div class="bd">
                        ...
                        <div class="demo"><img src="{WEB_THEME}mobile/static/picture/berneck-05.jpg"></div>
                        <div class="metas">
                ...
                <div class="wm">
                    ...
                    <div class="bd">
                        <div class="berneck-certs swiper-container" id="j_certs_slide">
                            ...
                            {sdcms:rs top="1" table="sd_model_page" where="cid=40"}
                                        {php $piclist=json_decode($rs[piclist],true);}
                                        {/sdcms:rs}
                                        {foreach $piclist as $key=>$rs}
                                <div class="swiper-slide certs-item"><img src="{$rs['image']}" alt="{$rs['desc']}"></div>
                                {/foreach}
                        </div>
