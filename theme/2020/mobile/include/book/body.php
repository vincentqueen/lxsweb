...
<form class="ui-form ui-mt-20" method="post">
	...
	<div class="ui-form-group">
		<textarea name="remark" class="ui-form-ip form-limit" data-max="255" rows="4" placeholder="请输入留言内容" data-rule="留言内容:required;"></textarea>
	...
	<div class="ui-form-group">
		<input type="hidden" name="token" value="{$token}"><input type="submit" class="ui-btn ui-btn-block ui-btn-blue" value="提交">
	</div>
</form>