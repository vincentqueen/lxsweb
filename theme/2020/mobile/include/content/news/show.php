		...
		{if $viewstate<100}
			<div class="ui-card ui-mt-20">
				...
				<div class="ui-card-body">
					...
					{/if}
					{if $viewstate==3}
						本文需要购买后才能继续阅读，价格：<span class="ui-text-red">{$price}</span> 元　 <a href="javascript:;" class="ui-modal-show" data-target="#my-modal-pay">【购买】</a>
					{/if}
					</div>
				</div>
			</div>
...
{if $price>0}
<div class="ui-modal" id="my-modal-pay">
	...
	<div class="ui-modal-body">
		<form method="post" id="form_buy">
			...
			<button type="submit" class="ui-btn ui-btn-blue ui-btn-block ui-btn-big ui-mt-20">支付：{$price}元</button>
		</form>
	</div>
</div>
{/if}