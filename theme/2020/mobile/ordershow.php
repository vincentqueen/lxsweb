	...
	<div class="ui-mwidth">
		<div class="ui-box ui-p-10">
			...
			<div class="order-base">
				...
				<p><span>金　额：</span><em>{$pro_price}</em></p>
			</div>
			...
			<div class="order-pay">
				...
				<form method="post" id="form_order">
					...
					<button type="submit" class="ui-btn ui-btn-block ui-btn-blue ui-mt-20">在线支付</button>
				</form>
			</div>
			{/if}
			<!--over-->
					...
					$.ajax(
					{
						...
						success:function(d)
						{
							...
							if(d.state=='success')
							{
								...
								{
									'title':name+"支付",
									'text':'<div class="ui-text-center"><div id="qrcode" style="width:300px;height:300px;"></div><p>请打开【'+name+'】，使用【扫一扫】完成付款。</p></div>',
									'okval':'已完成支付',
									'ok':function(e)
									{
										location.href='{THIS_LOCAL}';
